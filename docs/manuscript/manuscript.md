...
- $\sigma$: 誤差分散の平方根．
- $\nu$: 自由度パラメータ．
- $\mu_{\text{island}}$: 島効果の平均．
- $\sigma_{\text{island}}$: 島効果の標準偏差．
- $\mu_{\text{year}}$: 年効果の平均．
- $\sigma_{\text{year}}$: 年効果の標準偏差．
- $\hat{R}$: ゲルマン・ルービンの収束診断．
...
- $\sigma_{\zeta}$: トレンドの傾きの誤差項の分散．
- $\sigma_{w}$: トレンドの潜在状態の誤差項の分散．
- $\sigma_{v}$: 介入効果の誤差項の分散．
- $\hat{R}$: ゲルマン・ルービンの収束診断．
...
Fully Saturated TWFE の推定結果は以下の通りである．
...
$\beta_{e, \ell}$ は介入年別及び経過年数別に合計 $250$ 個の介入効果を推定した．その後同じ経過年数を持つパラメータの事後分布を平均し，経過年数別の介入効果を推定した．その結果が以下である．
...
事後分布のサンプルからそれぞれの期間において $0$ を上回る確率を計算した結果を下の表にまとめた．介入前の全期間において $0$ を上回る確率は $38.574\%$ であったが，介入後の全期間において $0$ を上回る確率は $70.884\%$ であった．介入後を $10$ 年毎に区切って計算すると，介入後の $10$ 年間において $0$ を上回る確率は $53.516\%$，$20$ 年間において $0$ を上回る確率は $64.984\%$，$30$ 年間において $0$ を上回る確率は $66.738\%$，$40$ 年間において $0$ を上回る確率は $68.130\%$，$50$ 年間において $0$ を上回る確率は $70.884\%$ であった．

|    介入前     |  正の確率  |   介入後    |  正の確率  |
| :-----------: | :--------: | :---------: | :--------: |
| $-46 \sim -1$ | $38.574\%$ | $0 \sim 50$ | $70.884\%$ |
| $-10 \sim -1$ | $35.713\%$ | $0 \sim 10$ | $53.516\%$ |
| $-20 \sim -1$ | $38.697\%$ | $0 \sim 20$ | $64.984\%$ |
| $-30 \sim -1$ | $39.393\%$ | $0 \sim 30$ | $66.738\%$ |
| $-40 \sim -1$ | $39.878\%$ | $0 \sim 40$ | $68.130\%$ |
