...
Angrist and Pischke (2009) (p.196) によると，$3$ 期間以上のデータがある場合は，個体別のタイムトレンドを含むモデルを推定することで，平行トレンドの仮定を緩め，より頑健で説得力のある推定が可能である．今回の分析では $1960$ 年から $2020$ 年までの $13$ 期間のデータがあるため，この方法を用いることができる．
