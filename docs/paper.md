...
![介入前トレンド (全体)](./figures/pre_trend_all.png)
...
本項では，$2$ 節で提案した $3$ つのモデルを用いて，離島架橋の介入効果の推定結果を示す[^6]．
